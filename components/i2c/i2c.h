...
/** ADDITION
 * @brief Turns on slave emulation mode for our desired functionalities to work.
 * @param i2c_num   desired I2C port on ESP32
 * @param thresh    threshold of bytes to receive before invoking custom interrupt handler of slave device
 * @param handler   custom interrupt handler of slave device
 * @param ints      interrupt mask to disable unwanted hardware module I2C interrupts
*                   (configuration differs depending on whether or not the slave device supports RESTART conditions)
*/
